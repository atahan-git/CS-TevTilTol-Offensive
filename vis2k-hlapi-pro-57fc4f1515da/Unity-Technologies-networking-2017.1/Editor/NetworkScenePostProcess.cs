    ...
    public class NetworkScenePostProcess : MonoBehaviour
    {
        ...
        public static void OnPostProcessScene()
        {
            ...
            foreach (NetworkIdentity uv in uvs)
            {
                ...
                // vis2k: multiple NetworkIdentity saftey check was moved to OnValidate. That should be enough.
                // note: not called when building, but immediately after when going back to th Editor. Good enough.
            }
        }
    }
}
